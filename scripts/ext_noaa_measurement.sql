CREATE OR replace external TABLE weather.ext_noaa_measurement(
    ...
    --DATEPART TIMESTAMP as TO_TIMESTAMP(substr(metadata$filename, 88,11), 'YYYYMMDD_HH24'),
    ...
    --PARTITION BY (DATEPART)
	LOCATION=@public.DMS_S3_Source_data_enc/Datalake_Raw/Weather/Noaa/measurement/Latest_48Hours    
