create or replace TABLE CRIS.CONTAINER_PGEP8FPOSPHY (
	...
	"u4308_comments" VARCHAR(1000),
	"u7688_filingguidelines" VARCHAR(1000),
	"u5118_officeofrecord" VARCHAR(128),
	"u3238_rcnumber" VARCHAR(3),
	"u3038_fppatterncode" VARCHAR(32),
	"u8488_fprcnumber" VARCHAR(4),
	...
	"u58f8_entrytemplateobjectstore" VARCHAR(64),
	"u9465_entrytemplateid" VARCHAR(36),
	"uf1c8_pgeidentifier" VARCHAR(64),
